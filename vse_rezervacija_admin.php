...
$query = "SELECT r.datum_odhoda as datumod,r.datum_prihoda as datumdo, o.ime as oime, o.priimek as opriimek, a.ime as aime,o.id, a.id as aid FROM rezervacije r INNER JOIN osebe o ON r.oseba_id = o.id "
